...
//ex 3
var databasejson:any ={


    oracle : ():string => {return "oracle connect soon..";},
    mysql: ():string => {return "mysql connect soon";},
    mssql: ():string => {return "msqsql connect soon";},
    mongodb: ():string => {return "mongodb connect soon";}
};
...
for(var i:number=0;i<wwdata.records.length;i++)
{
var obj:any=wwdata.records[i];
